...
Status: repository candidate; public release is blocked by the external actions below.
...
3. The release manager must then verify CI, merge the pull request, deploy the merged SHA, execute the
